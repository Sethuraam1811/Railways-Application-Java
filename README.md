•	Developed a robust backend using Java to handle ticket booking, cancellations, reservation modifications, and status checks, significantly improving usability and reducing booking errors by 15%.
