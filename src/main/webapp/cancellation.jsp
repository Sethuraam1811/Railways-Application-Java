...
<body>
	...
	<main>
		<div id="bookingDetails">
			<h2>The booking has been cancelled</h2>
			<table class=confirmTrain>
				<% 
					int i=1;
					List<Booking> list  = (List) request.getAttribute("cancelbooking");
					for(Booking b : list) {
				...
				<% 
					int j=1;
					List<Passenger> lst = (List) request.getAttribute("cancelpassenger");
					for(Passenger p : lst) {
